...
def make_exe(dist):
    ...
    python_config.run_command = "import restic.console; restic.console.cli()"
    ...
    for res in exe.pip_install(["dist/resticrc-0.1.0-py3-none-any.whl"]):
        res.add_location = "filesystem-relative:lib"
